...
function ProductItemFunc({ product }) {
  return (
    <div style={{ display: "inline-block", margin: "50px" }}>
      ...
      <img src={product.productImage} alt="Nike-Shoe" className="sneaaker-img" />
        <IsThisProductExpired expiredDate={product.expiredDate} image={product.productImage}></IsThisProductExpired>
